...
int readFromFileT(const char filename[], std::string & linea);
/**
...
public:
    ...
    int readFromFileT(const char filename[]);
    ...
    int saveToFileT(const char filename[]) const;
    /**
    ...
    void mergeByte(Byte &nuevo, Byte base, int merge);
   ...
   /**
     ...
     */
    bool showImage(int k, Image &result);
...
private:
    ...
    void apuntarpunt(int width, int height);
    /**
