...
LDLIBSOPTIONS=-L../MPTools/dist/Debug/GNU-Linux -lmptools
...
${OBJECTDIR}/_ext/49bc9a90/Byte.o: ../../Escritorio/Imaging5/src/Byte.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../MPTools/include -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/49bc9a90/Byte.o ../../Escritorio/Imaging5/src/Byte.cpp

${OBJECTDIR}/_ext/49bc9a90/Histogram.o: ../../Escritorio/Imaging5/src/Histogram.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/49bc9a90
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../MPTools/include -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/49bc9a90/Histogram.o ../../Escritorio/Imaging5/src/Histogram.cpp

${OBJECTDIR}/_ext/49bc9a90/Image.o: ../../Escritorio/Imaging5/src/Image.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/49bc9a90
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../MPTools/include -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/49bc9a90/Image.o ../../Escritorio/Imaging5/src/Image.cpp

${OBJECTDIR}/_ext/49bc9a90/main.o: ../../Escritorio/Imaging5/src/main.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/49bc9a90
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../MPTools/include -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/49bc9a90/main.o ../../Escritorio/Imaging5/src/main.cpp
